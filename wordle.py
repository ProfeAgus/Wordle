...
- cuando termine el juego, que muestre la palabra adivinada (1)    
- que avise cuantas letras tiene la palabra durante el juego (1)
- cambiar el subrayado del input del jugador por otro estilo y que haya por lo menos una palabra más que tenga color * (1)
